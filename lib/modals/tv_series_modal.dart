...
class TvSeriesModal {
    ...
    factory TvSeriesModal.fromRawJson(String str) => TvSeriesModal.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory TvSeriesModal.fromJson(Map<String, dynamic> json) => TvSeriesModal(
        page: json["page"],
