...
class MovieDetailModal {
    ...
    factory MovieDetailModal.fromRawJson(String str) => MovieDetailModal.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory MovieDetailModal.fromJson(Map<String, dynamic> json) => MovieDetailModal(
        adult: json["adult"],
